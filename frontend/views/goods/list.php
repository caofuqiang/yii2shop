...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="index.html">首页</a> > <a href=""><?=\frontend\models\GoodsCategory::findOne(['id'=>$cate])->name?></a></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_left fl mt10">
        <!-- 分类列表 start -->
        <div class="catlist">
            <h2><?=\frontend\models\GoodsCategory::findOne(['id'=>$cate])->name?></h2>
                ...
                <?php
                    foreach ($goods as $good){
                        ...
                        echo           '<dt><a href="goods.html?cate='.$cate.'&id='.$good['id'].'">';
                                        /*输出商品图片*/
                        echo                \yii\helpers\Html::img($good['logo']);
                        echo                '</a></dt>';
