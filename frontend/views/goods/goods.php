...
-->            <h3><strong><?=$goods_info['name']?></strong></h3>
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://admin.yii2shop.com/<?=$goods_pic[0]['path']?>"  class="jqzoom" rel="gal1">                       <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                    <?=\yii\helpers\Html::img(Yii::getAlias('http://admin.yii2shop.com'.$goods_pic[0]['path']),['style'=>'width:350px;height:348px'])?>
                                     <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                        ...
                        <ul>
                            ...
                            foreach ($goods_pic as $pic):?>
                                <li <?=$count==0?'class="cur"':'';?>>
                                    <a <?=$count==0?'class="zoomThumbActive"':'';?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo 'http://admin.yii2shop.com'.$goods_pic[$count]['path'] ?>',largeimage: '<?php echo 'http://admin.yii2shop.com'.$goods_pic[$count]['path'] ?>'}">
                                        <?=\yii\helpers\Html::img(Yii::getAlias('http://admin.yii2shop.com'.$goods_pic[$count]['path']),['style'=>'width:55px;height:50px','class'=>'goods_pic'])?>
                                    </a>
                                </li>
